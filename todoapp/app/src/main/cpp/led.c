...
Java_com_example_android_architecture_blueprints_todoapp_AlarmReceiver_LEDWrite(JNIEnv *env, jobject thiz, jint data) {
    // TODO: implement LEDWrite()
    int fd, ret;
...
JNIEXPORT jint JNICALL Java_com_example_android_architecture_blueprints_todoapp_taskdetail_TaskDetailActivity_LEDWrite(JNIEnv *env, jobject thiz, jint data) {
    // TODO: implement LEDWrite()
    int fd, ret;
